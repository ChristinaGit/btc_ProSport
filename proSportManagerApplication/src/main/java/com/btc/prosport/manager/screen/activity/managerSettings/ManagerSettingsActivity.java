package com.btc.prosport.manager.screen.activity.managerSettings;
...
@Accessors(prefix = "_")
public class ManagerSettingsActivity extends BaseManagerActivity implements ProSportSettingsScreen {
    @NonNull
    public static Intent getIntent(@NonNull final Context context) {
        Contracts.requireNonNull(context, "context == null");

        return new Intent(context, ManagerSettingsActivity.class);
    }
    ...
    public void bindViews() {
        ...
        _contentView = findViewById(R.id.manager_settings_view);
    }
    ...
    @Override
    public void displayPlayer(final User user) {
        _user = user;
        if (_loadingView != null && _loadingView.getVisibility() == View.VISIBLE) {
            _loadingView.setVisibility(View.GONE);
        }
    ...
    @Override
    public void displayRequireAuthorizationError() {
        if (_loadingView != null && _loadingView.getVisibility() == View.VISIBLE) {
            _loadingView.setVisibility(View.GONE);
        }
    ...
    private UserSettingsFragment getSettingsFragment() {
        ...
        if (manager != null) {
            return (UserSettingsFragment) manager.findFragmentById(R.id.manager_settings);
        }
        return null;
    }
}
